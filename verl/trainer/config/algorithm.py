...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        mask_after_last_lean_block (bool): Whether to zero the PPO response mask after the
            last closed ```lean4 block, so tokens the reward never read get no gradient.
